                          ...
                          <li className="main-header__item">
                              <a href="#" className="main-header__link">فرانت اند
                                  ...
                                  <ul className="main-header__dropdown">
                                      ...
                                      <li className="main-header__dropdown-item">
                                          <a href="#" className="main-header__dropdown-link">آموزش جاوا
                                              اسکریپت</a>
                                      </li>
                                      <li className="main-header__dropdown-item">
                          ...
                          <li className="main-header__item">
                              <a href="#" className="main-header__link">امنیت
                                  ...
                                  <ul className="main-header__dropdown">
                                      ...
                                      <li className="main-header__dropdown-item">
                                          <a href="#" className="main-header__dropdown-link">آموزش جاوا اسکریپت
                                              سیاه</a>
                                      </li>
                                      <li className="main-header__dropdown-item">
                          ...
                          <li className="main-header__item">
                              <a href="#" className="main-header__link">پایتون
                                  ...
                                  <ul className="main-header__dropdown">
                                      ...
                                      <li className="main-header__dropdown-item">
                                          <a href="#" className="main-header__dropdown-link">دوره هوش مصنوعی با
                                              پایتون</a>
                                      </li>
                                      <li className="main-header__dropdown-item">
